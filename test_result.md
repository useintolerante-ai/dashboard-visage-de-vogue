...
## agent_communication:
    - agent: "main"
    - message: "✅ TABELA CREDIÁRIO SIMPLIFICADA E DIAS CORRIGIDOS: 1) Tabela do crediário agora mostra apenas Cliente e Saldo Devedor para melhor visualização, 2) Total Vendas e Nº Compras movidos para área expandida ao clicar no cliente, 3) Lógica de dias corrigida: agosto=25 dias (não em atraso), setembro=15 dias (muito recente), julho=60 dias, 4) CARI AMARAL agora 25 dias (pagou agosto, não atrasada), LUCIANDREA 15 dias (pagou setembro), 5) Clientes com <30 dias excluídos da lista de atraso, 6) Sistema funcional com 4 abas e dados realistas. Dashboard otimizado para gestão eficiente!"